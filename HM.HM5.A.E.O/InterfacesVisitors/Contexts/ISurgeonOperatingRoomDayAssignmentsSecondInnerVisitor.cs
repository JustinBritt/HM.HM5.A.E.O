namespace HM.HM5.A.E.O.InterfacesVisitors.Contexts
{
    ...
    public interface ISurgeonOperatingRoomDayAssignmentsSecondInnerVisitor<TKey, TValue> : IVisitor<KeyValuePair<TKey, TValue>>
        where TKey : FhirDateTime
        where TValue : INullableValue<bool>
    {
        RedBlackTree<ItIndexElement, IxParameterElement> RedBlackTree { get; }
    }
}