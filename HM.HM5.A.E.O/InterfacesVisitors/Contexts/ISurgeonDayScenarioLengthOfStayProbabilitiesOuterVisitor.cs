namespace HM.HM5.A.E.O.InterfacesVisitors.Contexts
{
    ...
    public interface ISurgeonDayScenarioLengthOfStayProbabilitiesOuterVisitor<TKey, TValue> : IVisitor<KeyValuePair<TKey, TValue>>
        where TKey : Organization
        where TValue : RedBlackTree<INullableValue<int>, RedBlackTree<INullableValue<int>, INullableValue<decimal>>>
    {
        RedBlackTree<IsIndexElement, RedBlackTree<IlIndexElement, RedBlackTree<IΛIndexElement, IpParameterElement>>> RedBlackTree { get; }
    }
}